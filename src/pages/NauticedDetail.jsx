...
import { nauticedCourses, SAILING_IMAGE } from '@/lib/internationalData';
import CertCourseRow from '@/components/international/CertCourseRow';

export default function NauticedDetail() {
  return (
    <div className="pt-20">
      {/* Hero Banner */}
      <div className="relative h-[50vh] md:h-[60vh] overflow-hidden">
        <img src={SAILING_IMAGE} alt="NauticEd" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex flex-col justify-end px-6 md:px-12 pb-12 max-w-[1440px] mx-auto">
          ...
          <h1 className="font-archivo text-3xl md:text-5xl lg:text-6xl tracking-wide text-white mb-4">NauticED

          </h1>
          <p className="font-inter text-base md:text-lg text-white/60 max-w-2xl leading-relaxed">
            NauticEd Sailing Education — reconhecida em todos os países mediterrâneos e principais empresas de charter do mundo.
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              <h2 className="font-archivo text-2xl tracking-wide text-navy mb-6">SOBRE A NauticED</h2>
              <p className="font-inter text-base text-muted-foreground leading-relaxed mb-4">
                A NauticEd é uma das únicas organizações fora da RYA autorizada a emitir a Sailing License &amp; Credentials (SLC), aceita em todos os países do Mediterrâneo. Seus cursos online de alta qualidade combinam teoria, logbook eletrônico e avaliação prática presencial, resultando em um currículo náutico completo e verificável.
              </p>
              <p className="font-inter text-base text-muted-foreground leading-relaxed">
                Especialmente indicada para brasileiros que desejam fazer charter na Europa, Caribe e Mediterrâneo. O sistema de logbook digital facilita o acompanhamento da experiência acumulada, exigida para as certificações mais avançadas.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="border border-chart-grey p-8 space-y-5">
                <div>
                  ...
                  <p className="font-inter text-sm text-navy leading-relaxed">Todos os países mediterrâneos, Caribe e principais empresas de charter globais.</p>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 font-inter text-sm text-navy">
                    <li>• Sailing License &amp; Credentials (SLC)</li>
                    <li>• Logbook eletrônico verificável</li>
                    <li>• Cursos 100% online + avaliação presencial</li>
                    <li>• Equivalente ao ICC</li>
                  </ul>
                </div>
                <div className="h-px bg-chart-grey" />
                <a
                  href="https://www.nauticed.org"
                  target="_blank"
                  ...
                  VISITAR NAUTICED <ExternalLink className="w-3 h-3" />
                </a>
                <a
                  href="/#contact"
              ...
              <div className="border border-orange/20 bg-orange/5 p-6">
                ...
                <p className="font-inter text-sm text-muted-foreground leading-relaxed mb-4">
                  Combine a NauticEd com sua certificação da Marinha do Brasil para um perfil internacional completo.
                </p>
                <a
                  href="/#contact"
